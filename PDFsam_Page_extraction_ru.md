...
После завершения задания рядом с кнопкой _Выполнить_ отобразится надпись _Выполнено_ и закрашенная до конца полоса индикатора выполнения: 

<img src="https://github.com/vrbtm/tech_writing/blob/b54df565432fb649449220e66c80151fdc663c34/img/pdfsam_ext6.png" width="60%">

Также отобразится кнопка _Открыть_. Если её нажать, откроется папка, в которой были сохранены созданные файлы:
