...
В нём объясняется, как работать с облачным хранилищем  - в том числе загружать в него файлы и папки, удалять их и восстанавливать, предоставлять доступ к объектам в хранилище другим сотрудникам.
