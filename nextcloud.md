...
6.1. Если вы хотели бы восстановить данный файл (отменить удаление), перейдите в папку _Корзина_:
...
При нажатии кнопки _Вставить_ ссылка на данный файл будет скопирована в буфер обмена, и вы сможете отправить её по электронной почте, в мессенджере и т.д. Для вставки ссылки нужно щёлкнуть правой кнопкой в поле набора сообщения или создания письма и выбрать пункт _Вставить_.
