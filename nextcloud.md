...
Инструкция предназначена для сотрудников научного института: учёных, инженеров, административных работников. Она объясняет, как работать с облачным хранилищем на основе открытого ПО NextCloud - в том числе загружать в него файлы и папки, удалять их и восстанавливать, предоставлять доступ к объектам в хранилище другим сотрудникам.
